...
$(document).ready(function(){
    ...
    oTable = $("#table_data").dataTable({
        ...
        "ajax": {
            "url": "/new/version/sql/review/job/data",
            "type": "GET",
            "data": function(d){
    ...
    $body.on("click", "#view_report",  function(){
      ...
      if(item.length != 1) {
        ...
        $.post("/new/version/sql/review/task/rule/info", {"flag": "1", "task_uuid": task_uuid, "rule_type": rule_type}, function(result){
...
function fn_rule_detail(obj){
   ...
   $.post("/new/version/sql/review/task/rule/detail/info", {"task_uuid": task_uuid, "rule_name": rule_name}, function(result){
...
function fn_plan_rule_detail(obj){
  ...
  $.post("/new/version/sql/review/task/rule/plan/info", JSON.stringify(json_data), function(result){
...
function fn_text_rule_detail(obj){
  ...
  $.post("/new/version/sql/review/task/rule/text/info", JSON.stringify(json_data), function(result){
